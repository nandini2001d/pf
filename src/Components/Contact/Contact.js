...
export default function Contact() {
  ...
  const contactData=async(e)=>{
      ...
      set(newRef,{
        ...
        toast.success("Your message send successfully. I will contact you sortly, Thank You!!");
        setName('');
        setEmail('');
        setMobile('');
        setHelp('');
  ...
  return (
    <>
     ...
     <section style={{backgroundColor:"rgb(248, 245, 245)",paddingBottom:"50px"}}>
     <div className='container mt-5 text-center'>
          <div className='row mt-5'>
              ...
              <div className='col-sm-4 mt-4'>
                      ...
                      <h6>Nagpur,India</h6>
                      <p>Plot 863/5 , Bharatwada <br/>
                      Pardi HB-Town - 440035 <br/>
                      <BiPhone/> 801 064 9831</p>
              ...
              <div className='col-sm-4 mt-4'>
                      ...
                      <h6>Lonara, India</h6>
                      <p>JIT, Village Lonara,<br/>
                         Nagpur - 441111 <br/>
                      <BiPhone/> 0712 266 8234</p>
              ...
              <div className='col-sm-4 mt-4'>
                      ...
                      <p>At.Tirri, Ta.Pauni<br/>
                      Dis. Bhandara - 441910 <br/>
                      <BiPhone/> 838 084 8467</p>
...
<div class="mb-4">
  <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="Your email address" required
   style={{border:"1px solid black"}}
   value={email} name="email" onChange={(e)=>{setEmail(e.target.value)}}/>
</div>
<div class="mb-4">
  <input type="number" class="form-control" id="exampleFormControlInput3" placeholder="Mobile no." required
   style={{border:"1px solid black"}}
   value={mobile} name="mobile" onChange={(e)=>{setMobile(e.target.value)}}/>
</div>
...
<div class="mb-4">
  ...
  value={help} name="help" onChange={(e)=>{setHelp(e.target.value)}}></textarea>
</div>
...
<button type='submit' className='btn btn-dark'>SEND MESSAGE</button>
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3720.8241446505363!2d79.14974457526017!3d21.159395580522897!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjHCsDA5JzMzLjgiTiA3OcKwMDknMDguNCJF!5e0!3m2!1sen!2sin!4v1722535614721!5m2!1sen!2sin" width="100%" height="300" style={{border:"0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </section>
