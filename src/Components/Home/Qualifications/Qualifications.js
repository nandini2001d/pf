  ...
  React.useEffect(() => {
    const timer = setInterval(() => {
      setProgress((prevProgress) =>
        prevProgress >= 79.4 ? 79.4 : prevProgress + 1
      );
      setProgress12((prevProgress) =>
        prevProgress >= 61.08 ? 61.08 : prevProgress + 1
      );
      setProgress13((prevProgress) =>
        prevProgress >= 82 ? 82 : prevProgress + 1
      );
      setProgress14((prevProgress) =>
