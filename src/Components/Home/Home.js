  ...
  return (
    <>
          ...
          <div className="col-lg-6 col-sm-12">
            <div className="data mt-5">
              ...
              <p className="mt-5 text-left">
                I am java fullstack developer and I am good in Frontend as well
                ...
                Docker file , Firebase , Project deployment etc.
              </p>
      ...
      <section>
        <div className="row">
          <div
            className="col-lg-6 col-sm-12 text-center mt-5"
            style={{
              maxWidth: "100%",
              padding: "0",
              margin: "0",
          ...
          <div
            className="col-lg-6 col-sm-12 text-center mt-lg-5 mt-3"
            style={{
              maxWidth: "100%",
              padding: "0",
              margin: "0",
